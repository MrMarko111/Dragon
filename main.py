...
[ layer4 ]    | description of methods layer4
[ owner ]     | contact admin
""")
...
"""
def main(username):
	sys.stdout.write(f"""\x1b]2;[\] SkyranX-Mods :: User: [{username}] :: Server: [Offline] :: Expired: [{bot2}] :: Version: [V1]\x07""")
